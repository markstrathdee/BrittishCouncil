...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%-- Removing create/control function.  C# code commented out as well.
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td>
                <asp:FileUpload ID="LocalFileUpload" runat="server" />
             </td>
        </tr>
            <td><asp:TextBox ID="TextBoxNewEventGUID" runat="server" Visible="False"></asp:TextBox></td>
            <td><asp:Button ID="ButtonUploadCameraFile" runat="server" OnClick="ButtonUploadCameraFile_Click" Text="Create &amp; Prepare" /></td>
        </tr>
    </table>
</asp:Content>
