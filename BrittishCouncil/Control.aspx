...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <p>
            ...
            <p>
            <asp:DropDownList ID="DropDownListSelectEvent" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataSourceID="LinqDataSourceSelectEvent" DataTextField="LocalEventName" DataValueField="LocalEventID">
                        <asp:ListItem>Select an Event</asp:ListItem>
                    </asp:DropDownList>
                    <asp:LinqDataSource ID="LinqDataSourceSelectEvent" runat="server" ContextTypeName="BrittishCouncil.CascadeEdgeCaptureDataContext" EntityTypeName="" TableName="TableLocalEvents" OrderBy="LocalEventReleaseDate">
                    </asp:LinqDataSource>
               </p>
...
<script type='text/javascript'>
    jwplayer('playercamera1').setup({
        file: 'http://phillaptop-pc:1935/cascadeorigin/camera1/playlist.m3u8',
...
<script type='text/javascript'>
    jwplayer('playercamera2').setup({
        file: 'http://phillaptop-pc:1935/cascadeorigin/camera2/playlist.m3u8',
        image: '//www.longtailvideo.com/content/images/jw-player/lWMJeVvV-876.jpg',
        width: '100%',
        aspectratio: '16:9',
        mute: 'true',
...
<script type='text/javascript'>
    jwplayer('playercamera3').setup({
        file: 'http://phillaptop-pc:1935/cascadeorigin/camera3/playlist.m3u8',
        image: '//www.longtailvideo.com/content/images/jw-player/lWMJeVvV-876.jpg',
        width: '100%',
        aspectratio: '16:9',
        mute: 'true',
